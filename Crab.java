...
public class Crab extends Actor {
	...
	public Crab(Double startingPosition, Double initHitbox, BufferedImage img, int health, int coolDown, double speed, int attackDamage) 
	{
	...
	{
		if ((other instanceof Lifeguard || other instanceof Projectile) && this.isCollidingOther(other))
			setColliding(true);
	}
	...
	{
		if (other instanceof Lifeguard || other instanceof Projectile)
		{
			super.attack(other);
		}
	}
