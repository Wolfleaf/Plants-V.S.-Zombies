...
public class Zombie extends Actor {
	...
	public Zombie(Double startingPosition, Double initHitbox, BufferedImage img, int health, int coolDown, double speed, int attackDamage) 
	{
	...
	{
		if ((other instanceof Plant || other instanceof Projectile) && this.isCollidingOther(other))
			setColliding(true);
	}
